...
inline string** ReadSectorBigByte(LPCWSTR drive, long long  readPoint, BYTE sector[512])
{
    int retCode = 0;
    DWORD bytesRead;
    HANDLE device = NULL;
    ...
    SetFilePointer(device, li.LowPart, &li.HighPart, FILE_CURRENT);//Set a Point to Read
